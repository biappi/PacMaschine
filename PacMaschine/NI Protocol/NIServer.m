...
static CFDataRef CreateResponseForServerPortCallback(CFMessagePortRef local,
                                                     SInt32 msgid,
                                                     CFDataRef data,
                                                     void *info);
...
- (id)initWithName:(NSString *)theName;
{
    ...
    port = CFMessagePortCreateLocal(NULL,
                                    ...
                                    CreateResponseForServerPortCallback,
                                    &context,
                                    NULL);
...
CFDataRef CreateResponseForServerPortCallback(CFMessagePortRef local,
                                              SInt32 msgid,
                                              CFDataRef data,
                                              void * info)
{
